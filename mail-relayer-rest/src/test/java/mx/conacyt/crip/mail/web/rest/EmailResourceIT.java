...
public class EmailResourceIT {
    ...
    public void sendMailSync() throws Exception {
        ...
        server.reset();
        // When
        restEmailMockMvc.perform(post("/api/emails").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void sendMailAsyncSuccess() throws IOException, Exception {
        ...
        server.reset();
        // When
        restEmailMockMvc.perform(post("/api/emails?async=true").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(TestUtil.convertObjectToJsonBytes(email())))
        // @formatter:off
        // Then
        // @formatter:on
