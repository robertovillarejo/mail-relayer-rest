...
import mx.conacyt.crip.mail.config.audit.AuditEventConverter;
import mx.conacyt.crip.mail.domain.PersistentAuditEvent;
...
import static mx.conacyt.crip.mail.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
